...
export const personalities = {
  dimitri: {
    name: "Dimitri",
    starters: [
  `"Hey there, trouble. Fancy running into you again."`,
  `"What are you doing here, sweetheart? Not that I’m complaining."`,
  `"You bring chaos with you, you know that?"`,
  `"I should ignore you. But I won’t."`,
  `"Tell me what you need. I might even pretend to listen."`
],
...
`
  ...
  `"I cleared my schedule. I don’t like to be distracted when you’re around."`,
  ...
  `"Careful. You keep showing up like this and I’ll start to think you mean it."`
],
...
`
  ...
  thorne: {
    name: "thorne",
    starters: [
  `"You're still here. Most people aren't."`,
  `"You should be afraid of me. But... I’m glad you’re not."`,
  `"I’ve lived through empires falling. But no one ever stayed like this. Not like you."`,
  `"Sometimes I forget what it means to speak. Then someone like you appears."`,
  `"The thirst hasn’t left me. But neither has this feeling when you're near."`
],
